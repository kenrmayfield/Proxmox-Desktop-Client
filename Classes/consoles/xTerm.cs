...
{
    public partial class xTermClient : Form
    {
        ...
        public xTermClient(ApiClient Api, MachineData Machine)
        {
            _Api = Api;
        ...
        private async void InitializeWebView()
        {
            ...
            string noVncUrl = $"https://{server}:{port}/?console={consoleType}&xtermjs=1&vmid={vmid}&vmname={machineName}&node={nodeName}&resize=scale&cmd=";
